...
class LanguageModel(nn.Module):
    ...
    def forward_kv(self, x, past_key_values=None, attention_mask=None):
        ...
        past_length = past_length = 0 if past_key_values is None else past_key_values[0][0].shape[2] # past length is 0 if past_key_values is None, otherwise get the length from past_key_values
